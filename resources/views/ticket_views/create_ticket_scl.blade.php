                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="">
                                        <div class="form-group">
                                            ...
                                            <select name="problem_cat"id="client_name"name="client_name"class="form-control">
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                        ...
                                        <div class="form-group">
                                            <label>Responsible Field Team</label>
                                            <input type="text" name="responsible_field_team" id="responsible_field_team"class="form-control">
                                        ...
                                        <button type="submit" class="btn btn-success">Submit a Ticket</button>
